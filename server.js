...
app.get('/', (reqFromClient, responseToClient) => { //  get info for custmer
// redirects
responseToClient.redirect('/israel/confirmed');
});

app.get('/israel/confirmed', (reqFromClient, responseToClient) => { //  get info for custmer
  var str = '';
...
callback = function(responseOnCovid) { // what to do with unput
